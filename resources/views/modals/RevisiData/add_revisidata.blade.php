<!-- Modal -->
<div class="modal fade" id="add-revisidata-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <div class="input-group mb-3">
                                            <select class="form-select" id="add-jenis_revisi">
                            ...
                            <div class="col-md-8">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="date" class="form-control" placeholder="" id="add-tanggal_data">
                                        <div class="form-control-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-calendar-date" viewBox="0 0 16 16">
                                                <path
                            ...
                            <div class="col-md-8">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" class="form-control" placeholder="Jenis data" id="add-jenis_data">
                                        <div class="form-control-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <div class="col-md-8">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" class="form-control" placeholder="Nama data" id="add-nama_data">
                                        <div class="form-control-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <div class="">
                                <div class="form-group">
                                    <div class="position-relative">
                                        <div class="form">
                                            <textarea class="form-control" placeholder="" id="add-detail_revisi"
                            ...
                            <div class="">
                                <div class="form-group">
                                    <div class="position-relative">
                                        <div class="form">
                                            <textarea class="form-control" placeholder="" id="add-alasan_revisi"
                                                style="height: 100px"></textarea>
                                        </div>
                                    </div>
                                </div>
