<!-- Modal -->
<div class="modal fade" id="add-aksesinternet-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" class="form-control" placeholder="Name" id="add-nama">
                            ...
                            <div class="col-md-8">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" class="form-control" placeholder="Jabatan" id="add-jabatan">
                                        <div class="form-control-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <div class="position-relative">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Keperluan Email"
                                                id="add-keperluan_email" style="height: 100px"></textarea>
                                    ...
                                    <div class="position-relative">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Keperluan Browsing"
                                                id="add-keperluan_browsing" style="height: 100px"></textarea>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="store-aksesinternet">Submit</button>
            </div>
        </div>
    </div>
</div>
