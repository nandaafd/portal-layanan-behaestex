                    ...
                    <form action="" method="get" class="row row-cols-sm-auto g-1">
                        <div class="col-sm">
                            <div class="input-group">
                                <select class="form-select form-select-sm" name="status" id="filter-status-aksprog">
                        ...
                        <div class="col-sm">
                            <input class="form-control form-control-sm" type="text" name="nama_program" placeholder="cari nama program.." value="{{$nama_program}}" id="filter-nama-aksprog">
                        </div>
                        <div class="col-sm">
                            <input class="form-control form-control-sm" type="text" name="departemen" placeholder="cari departemen.." value="{{$departemen}}" id="filter-departemen-aksprog">
                        </div>  
                        <div class="col-sm">
                            <input type="button" class="btn btn-secodary btn-sm" value="Reset" onclick="" id="btn-reset-aksprog">
