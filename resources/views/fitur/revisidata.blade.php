                        ...
                        <table class="table mb-0 text-center table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" id="btn-view-revisidata" data-id="${response.data.id}" class="btn btn-secondary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#detail"><i class="bi bi-eye-fill"></i></a>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0)" id="btn-edit-revisidata" data-id="" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
                                        <a href="javascript:void(0)" id="btn-delete-revisidata" data-id="${response.data.id}" class="btn btn-danger btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
...
@include('modals.RevisiData.view_revisidata')
